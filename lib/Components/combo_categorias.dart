...
import 'package:fabrics_app/Models/category.dart';
...
class ComboCategorias extends StatefulWidget {
  ...
  const ComboCategorias({super.key, required this.onChanged, required this.backgroundColor, required this.categories,  required this.titulo});
