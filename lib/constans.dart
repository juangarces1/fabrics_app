...
const kColorRed = Color(0xffc91047);
...
const kGradientTexApp = LinearGradient(
  colors: [Color(0xffc91047), Color(0xffc94216)],
);
const kGradientAppBarHome = LinearGradient(
  colors: [Color.fromARGB(255, 101, 5, 139), Color(0xffc91047)],
);
const kGradientHome = LinearGradient(
  colors: [Color.fromARGB(255, 58, 4, 80), Color.fromARGB(255, 12, 2, 39)],
);
const kGradientCardNewOrder = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [
    Color.fromARGB(255, 12, 2, 39),
    Color.fromARGB(255, 61, 25, 159),
    Color.fromARGB(255, 213, 206, 17),
  ],
);
const kGradientCardListOrder = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [
    Color.fromARGB(255, 7, 79, 121),
    Color.fromARGB(255, 61, 25, 159),
    Color.fromARGB(255, 213, 206, 17),
  ],
);
const kAlternativeGradientColor = LinearGradient(
