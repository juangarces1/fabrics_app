...
import 'package:fabrics_app/Components/combo_suplliers.dart';
          ...
          Scaffold(
           ...
           bottomNavigationBar: BottomAppBar(
            ...
            floatingActionButton:  GestureDetector(
                onTap: () => goSave(),
                child: Container(
                  width: 60.0,  // Ajusta el tamaño según necesites
                  height: 60.0,
                  decoration: BoxDecoration(
                    color: kColorAlternativo,  // Color del botón
                    shape: BoxShape.circle,    // Hace que sea redondo
                    boxShadow: [
                      BoxShadow(
                        color: Colors.black.withOpacity(0.2),
                        blurRadius: 6.0,
                        offset: const Offset(0, 3),  // Sombra debajo del botón
                      ),
                    ],
                  ),
                  child: const Icon(
