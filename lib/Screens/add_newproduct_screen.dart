...
import 'package:fabrics_app/Models/color.dart';
import 'package:fabrics_app/Models/product.dart';
import 'package:fabrics_app/Models/productlist.dart';
...
class AddNewProductScreen extends StatefulWidget {
  const AddNewProductScreen({super.key, required this.user});
  final User user;
  @override
...
class _AddNewProductScreenState extends State<AddNewProductScreen> {
  ...
  void _goSave() async {
    ...
    Response response = await ApiHelper.post('api/Kilos/PostProduct/', request);
  ...
  _goAdd() {
    ...
    Category categoria = categories.firstWhere(
  ...
  List<DropdownMenuItem<String>> _getComboColors() {
    ...
    list.add(
      const DropdownMenuItem(value: '', child: Text('Seleccione un Color...')),
    );
        ...
        child: colors.isEmpty
            ...
            : DropdownButtonFormField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText: 'Color',
                  errorText: colorShowError ? colorError : null,
                ),
              ),
      ),
    );
  ...
  List<DropdownMenuItem<int>> _getComboMedida() {
    ...
    list.add(const DropdownMenuItem(value: 0, child: Text('Metros')));

    list.add(const DropdownMenuItem(value: 1, child: Text('Kilos')));
        ...
        child: colors.isEmpty
            ...
            : DropdownButtonFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: medShowError ? medError : null,
                ),
              ),
      ),
    );
  ...
  List<DropdownMenuItem<int>> _getComboCategories() {
    ...
    for (var item in categories) {
      list.add(
        DropdownMenuItem(value: item.id, child: Text(item.name.toString())),
      );
    }
        ...
        child: categories.isEmpty
            ...
            : DropdownButtonFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: catShowError ? catError : null,
                ),
              ),
      ),
    );
